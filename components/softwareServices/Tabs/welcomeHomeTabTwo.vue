<template>
    <div class=" welcome-home-tab-one">
        ...
        <div>
            1-ثبت ومدیریت قرارداد
        </div>
        <div>
            2)مدیریت اطلاعات پایه قراردادها
        </div>
        <div>
            3)سیستمی شدن اقدامات انجام شده برروی قراردادها
        </div>
        <div>
            4) مدل شدن انواع قراردادوفرم های مربوطه به صورت الکترونیکی
        </div>
        <div>
            5)دسترسی کاربران وکارمندان شعب به انواع قراردادها
        </div>
    </div>
</template>
<script>
