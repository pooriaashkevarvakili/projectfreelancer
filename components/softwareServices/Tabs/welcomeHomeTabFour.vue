<template>
    <div class="welcome-home-tab-one">
        <div>
            ...
            <button class="welcome-home-tab-seven-svg" type="button" @click="show">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"
                    height="40px" width="40px" version="1.1" id="Layer_1" viewBox="0 0 512.011 512.011"
                    xml:space="preserve">
                    <g>
                        <g>
                            <g>
        ...
        <div>
            سامانه خدمات الکترونیک صندوق (خاص)،ارائه دهنده خدمات بانکی وتسهیلاتی به مشتریان صندوق وسایر همچنین سایر افراد
            است.خاص داری امکانات بانکی
            (سپرده،کارت،شبا)مانند افتتاح حساب،انتقال وجه،دریافت شماره شباوخدماتی نظیر مشاهده جزئیات وپرداخت اقساط تسلیحات
            وثبت ومشاهده تعهدات مربوط به تسلیحات است
        </div>
    </div>
</template>
<script>
